...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('evaluasi-pertanyaan.update', $pertanyaan->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="mb-3">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('tipe_jawaban') is-invalid @enderror" id="tipe_jawaban" name="tipe_jawaban" required>
                            <option value="skala_1_5" {{ old('tipe_jawaban', $pertanyaan->tipe_jawaban) == 'skala_1_5' ? 'selected' : '' }}>Skala 1-5</option>
