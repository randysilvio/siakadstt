...
<div class="container-fluid px-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 mt-3">
        <div>
            <h3 class="fw-bold text-dark mb-0 uppercase">Edit Tahun Akademik</h3>
            <span class="text-muted small uppercase">Pembaruan Master Data Periode Perkuliahan & Rentang Waktu KRS</span>
        </div>
        <div>
    ...
    <div class="card border-0 shadow-sm rounded-0 border-top border-dark border-4 col-md-8 mx-auto mb-5">
        <div class="card-header bg-white py-3 border-bottom rounded-0 uppercase fw-bold small text-dark">
            Formulir Pembaruan Data Tahun Akademik
        </div>
        <div class="card-body p-4">
            <form action="{{ route('admin.tahun-akademik.update', $tahunAkademik->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row g-3 mb-3">
                    <div class="col-md-6">
                        <label for="tahun" class="form-label small fw-bold uppercase text-dark">Tahun Akademik <span class="text-danger">*</span></label>
                        <input type="text" class="form-control rounded-0 font-monospace uppercase @error('tahun') is-invalid @enderror" id="tahun" name="tahun" value="{{ old('tahun', $tahunAkademik->tahun) }}" placeholder="CONTOH: 2025/2026" required>
